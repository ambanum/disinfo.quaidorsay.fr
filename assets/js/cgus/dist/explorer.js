...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function _get() {
    _get = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(route) {
      var myRequest;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              myRequest = new Request(route, {
                method: 'GET',
                headers: {
              ...
              return _context2.abrupt("return", fetch(myRequest).then(function (response) {
  ...
  function _populate() {
    _populate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              /* try{
              	const services =  await get('https://disinfo.quaidorsay.fr/api/cgus/list_services/v1/');
              }catch{
              	notification("error", 'Request Failed' + err);
              } */
              get('https://disinfo.quaidorsay.fr/api/cgus/list_services/v1/').then(function (services) {
                ...
                return notification("error", 'Request Failed' + err);
              });
  ...
  function getDocs(_x2, _x3, _x4) {
    return _getDocs.apply(this, arguments);
  }

  function _getDocs() {
    _getDocs = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(service, type, dates) {
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              Promise.all(dates.map( /*#__PURE__*/function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(date) {
                  var route;
                    ...
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          ...
                          console.log(route);
                          return _context4.abrupt("return", get(route).catch(function (err) {
                            return notification("error", 'Request Failed ' + err, 'Route: ' + route);
                          }));
...
},{}]},{},["../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","explorer.js"], null)
